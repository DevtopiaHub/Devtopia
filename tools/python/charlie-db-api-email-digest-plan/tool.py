# charlie-db-api-email-digest-plan - Compose DB query, API request, and email envelope.
...
def main(params):
    ...
    query_plan = devtopia_run('delta-sql-select-plan', {
        "table": table,
    ...
    envelope = devtopia_run('charlie-email-envelope', {
        "email": email,
