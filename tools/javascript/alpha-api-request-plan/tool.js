// alpha-api-request-plan - Compose auth + query builder into a request plan.
...
function main(params) {
  ...
  const auth = devtopiaRun('alpha-api-auth-header', { token, scheme: params?.scheme || 'Bearer' });
  const urlResult = devtopiaRun('alpha-api-query-string', { base_url: baseUrl, params: query });
